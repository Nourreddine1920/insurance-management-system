...
int validate_iso_date(const char *date) {
    ...
    if (!is_digit_char(date[0]) || !is_digit_char(date[1]) || !is_digit_char(date[2]) || !is_digit_char(date[3]) ||
        !is_digit_char(date[5]) || !is_digit_char(date[6]) || !is_digit_char(date[8]) || !is_digit_char(date[9])) {
        return 0;
    }
